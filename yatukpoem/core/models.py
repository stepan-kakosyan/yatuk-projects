...
class ProductCategory(models.Model):
    title_en = models.CharField(max_length=255, null=False,
                                blank=False, verbose_name=_("Title English"))
    title_ru = models.CharField(max_length=255, null=False,
                                blank=False, verbose_name=_("Title Russian"))
    title_hy = models.CharField(max_length=255, null=False,
                                blank=False, verbose_name=_("Title Armenian"))
    ...
    icon = models.ImageField(upload_to="media/icon", null=True,
...
class Product(models.Model):
    ...
    title_hy = models.CharField(max_length=255, null=True, blank=True,
                                verbose_name=_("Title Armenian"))
    slug_en = models.CharField(max_length=255, null=True, blank=True,
                               verbose_name=_("Slug English"))
    slug_ru = models.CharField(max_length=255, null=True, blank=True,
                               verbose_name=_("Slug Russian"))
    slug_hy = models.CharField(max_length=255, null=True, blank=True,
                               verbose_name=_("Slug Armenian"))
    description_en = models.TextField(verbose_name=_("Description English"))
    description_ru = models.TextField(verbose_name=_("Description Russian"))
    description_hy = models.TextField(verbose_name=_("Description Armenian"))
    ...
    total_count = models.IntegerField(default=50,
...
class ProductImage(models.Model):
    ...
    optimized = models.ImageField(upload_to="media/product/optimized",
                                  ...
                                  blank=True)
    middle_optimized = models.ImageField(
        upload_to="media/product/middle_optimized",
        verbose_name=_("Image"), null=True, blank=True)
    thumbnail = models.ImageField(blank=True, null=True,
                                  upload_to='media/product/thumb/',
...
class ContactUs(models.Model):
    ...
    email_or_phone = models.CharField(max_length=255, null=False,
                                      blank=False,
...
class GameAuthor(models.Model):
    ...
    @property
    def bio(self):
        return getattr(self, f"bio_{get_language()}") if getattr(
            self, f"bio_{get_language()}") else ""

    @property
    def url(self):
        return f"https://canvas.yatuk.am/hy/author/{self.slug}/"


class Game(models.Model):
    author = models.ForeignKey(GameAuthor, on_delete=models.CASCADE,
                               null=False, blank=False, related_name="games")
    name_hy = models.CharField(max_length=255, null=False, blank=False)
    name_en = models.CharField(max_length=255, null=False, blank=False)
    name_ru = models.CharField(max_length=255, null=False, blank=False)
    ...
    background_position = models.CharField(max_length=255, default="center",
                                           blank=False)
    optimized = models.ImageField(
        upload_to="media/product/optimized",
        verbose_name=_("Image"), null=True, blank=True)
    middle_optimized = models.ImageField(
        upload_to="media/product/middle_optimized",
        verbose_name=_("Image"), null=True, blank=True)
...
class PoemAuthor(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    optimized = models.ImageField(
        upload_to="media/product/optimized", verbose_name=_("Image"),
        null=True, blank=True)
    middle_optimized = models.ImageField(
        upload_to="media/product/middle_optimized", verbose_name=_("Image"),
        null=True, blank=True)
    thumbnail = models.ImageField(blank=True, null=True,
                                  upload_to='media/product/thumb/',
                                  verbose_name=_("Thumbnail"))
...
class Poem(models.Model):
    ...
    author = models.ForeignKey(PoemAuthor, on_delete=models.CASCADE,
                               null=False, blank=False, related_name="poems")
    game = models.ForeignKey(Game, on_delete=models.SET_NULL, null=True,
                             blank=True, related_name="poems")
    name_hy = models.CharField(max_length=255, null=False, blank=False)
    ...
    @property
    def main_url(self):
        return reverse_lazy('poem', args=[self.author.slug,
                                          self.slug,
                                          self.id])
...
class PoemLabel(models.Model):
    ...
    poem = models.ForeignKey(Poem, on_delete=models.CASCADE,
                             null=False, blank=False, related_name="labels")
...
class PoemSection(models.Model):
    poem = models.ForeignKey(Poem, on_delete=models.CASCADE,
                             null=False, blank=False, related_name="sections")
...
class AudioAuthor(models.Model):
    ...
    optimized = models.ImageField(upload_to="media/authors/optimized",
                                  ...
                                  null=True, blank=True)
    middle_optimized = models.ImageField(
        upload_to="media/authors/middle_optimized",
        verbose_name=_("Image"), null=True, blank=True)
    thumbnail = models.ImageField(blank=True, null=True,
                                  upload_to='media/authors/thumb/',
                                  verbose_name=_("Thumbnail"))
    slug = models.SlugField(unique=True, null=False, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    @property
    def quote(self):
        return getattr(self, f"quote_{get_language()}") if getattr(
            self, f"quote_{get_language()}") else ""
...
class Audio(models.Model):
    ...
    def next_id(self):
        try:
            return Audio.objects.filter(id__gt=self.id).exclude(
                author=self.author).order_by('id').first().id
        except Exception:
    ...
    def prev_id(self):
        try:
            return Audio.objects.filter(id__lt=self.id).exclude(
                author=self.author).order_by('-id').first().id
        except Exception:
            return Audio.objects.exclude(id=self.id).first().id
...
class Like(models.Model):
    poem = models.ForeignKey(Poem, on_delete=models.CASCADE, null=False,
                             blank=False, related_name="likes")
...
class Favorite(models.Model):
    poem = models.ForeignKey(Poem, on_delete=models.CASCADE, null=False,
                             blank=False, related_name="favorites")
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=False,
                             blank=False, related_name="favorites")
    created_at = models.DateTimeField(auto_now_add=True)
...
class WantToRead(models.Model):
    poem = models.ForeignKey(Poem, on_delete=models.CASCADE, null=False,
                             blank=False, related_name="want_to_reads")
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=False,
                             blank=False, related_name="want_to_reads")
    created_at = models.DateTimeField(auto_now_add=True)
...
class AuthorBio(models.Model):
    author = models.OneToOneField(PoemAuthor, blank=False, null=False,
                                  related_name='bio', on_delete=models.CASCADE)
    bio_hy = models.TextField(null=True, blank=True)
    bio_en = models.TextField(null=True, blank=True)
    bio_ru = models.TextField(null=True, blank=True)
...
class Photo(models.Model):
    ...
    optimized = models.ImageField(upload_to="media/photo/optimized",
                                  ...
                                  blank=True)
    middle_optimized = models.ImageField(
        upload_to="media/photo/middle_optimized",
        verbose_name=_("Image"),
        null=True, blank=True)
    thumbnail = models.ImageField(blank=True, null=True,
                                  upload_to='media/photo/thumb/',
                                  verbose_name=_("Thumbnail"))
    background_position = models.CharField(max_length=255,
    ...
    @property
    def main_url(self):
        return reverse_lazy('photo', args=[self.slug, self.id])


class PhotoPerson(models.Model):
    photo = models.ForeignKey(Photo, on_delete=models.CASCADE,
                              null=False, blank=False, related_name="photos")
    writer = models.ForeignKey(PoemAuthor, on_delete=models.CASCADE,
                               null=True, blank=True, related_name="photos")
    composer = models.ForeignKey(AudioAuthor, on_delete=models.CASCADE,
                                 null=True, blank=True, related_name="photos")
    painter = models.ForeignKey(GameAuthor, on_delete=models.CASCADE,
                                null=True, blank=True, related_name="photos")
    text = models.TextField(null=False, blank=False)
    created_at = models.DateTimeField(auto_now_add=True)
