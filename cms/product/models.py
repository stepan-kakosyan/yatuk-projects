...
class ProductCategory(models.Model):
    ...
    def image_tag(self):
        return mark_safe('<img style="max-width:50px;max-height:75px;object-fit:contain" src="'+"/media/"+str(self.icon)+'" />')
...
class Product(models.Model):
    ...
    def image_tag(self):
        ...
        if images.exists():
            image = images.first()
            return mark_safe('<img style="max-width:50px;max-height:75px;object-fit:contain" src="'+"/media/"+str(image.thumbnail)+'" />')
        else:
            return "No image"
...
class ProductImage(models.Model):
    ...
    def image_tag(self):
        if self.thumbnail:
            return mark_safe('<img style="max-width:50px;max-height:75px;object-fit:contain" src="'+"/media/"+str(self.thumbnail)+'" />')
        else:
            return "No Image"
...
class Transfer(models.Model):
    ...
    amount = models.IntegerField(null=False, blank=False, verbose_name=_("Amount"))
    collaborator = models.ForeignKey(Collaborator, on_delete = models.PROTECT, related_name = "transfers", verbose_name=_("Collaboratir"))
    date = models.DateField(verbose_name=_("Date"), default=datetime.now())
    note = models.TextField(null=True, blank=True, verbose_name=_("Note"))
    created_at = models.DateTimeField(auto_now_add = True, verbose_name=_("Created At"))
...
class SketchImage(models.Model):
    ...
    thumbnail = models.ImageField(blank=True, null=True,upload_to ='media/sketch/thumb/', verbose_name=_("Thumbnail"))
